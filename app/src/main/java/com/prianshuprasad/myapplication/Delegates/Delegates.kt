...
import com.prianshuprasad.myapplication.utils.MediaNotification.MediaNotification
    ...
    override fun onContentPermissionRequest(
       ...
       when(perm.permission) {
         PERMISSION_DESKTOP_NOTIFICATION->  alert("Notification", siteData = SiteData(coreAdress = base_url))
           ...
           PERMISSION_AUTOPLAY_INAUDIBLE,PERMISSION_AUTOPLAY_AUDIBLE-> siteDataviewholder.insertnote(
               SiteData(coreAdress = base_url, permMedia = 1))
           PERMISSION_PERSISTENT_STORAGE-> {
